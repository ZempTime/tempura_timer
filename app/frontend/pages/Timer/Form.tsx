...
import { TimerFormType, TimerType } from './types'
...
interface FormProps {
  timer: TimerType
  onSubmit: (form: InertiaFormProps<TimerFormType>) => void
  submitText: string
}

export default function Form({ timer, onSubmit, submitText }: FormProps) {
  const form = useForm<TimerFormType>({
    name: timer.name,
  })
